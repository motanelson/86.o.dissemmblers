...
def parse_bytecodetree_tree(file_path):
...
def main():
    file_name = input("Enter the name of the .bc language file to load: ")

    try:
        tree = parse_bytecodetree_tree(file_name)
        print("\nParsed java byte code language Tree:")
        print(tree)
